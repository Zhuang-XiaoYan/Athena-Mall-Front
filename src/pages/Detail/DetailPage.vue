        ...
        <section class="con">
            ...
            <div class="mainCon">
                ...
                <div class="previewWrap">
                    <!--放大镜效果-->
                    <ZoomPage :skuImageList="skuImageList"/>
                    <!-- 小图列表 -->
...
<script>
import ZoomPage from "@/pages/Detail/Zoom/ZoomPage.vue"
import ImageList from "@/pages/Detail/ImageList/ImageList.vue"
import {mapGetters} from "vuex";

export default {
    name: 'DetailPage',
    components: {ZoomPage, ImageList},
    data(){
        return{
            // 购买的商品的数量
            skuNum:1,
    ...
    methods: {
        ...
        addShopCart(){
            try {
                ...
                // 2.路由跳转 在路由跳转的时候还需要将产品的信息带给下一级的路由组件
