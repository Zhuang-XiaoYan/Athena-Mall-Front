            ...
            <div class="cart-body">
                <ul class="cart-list" v-for="(cart,index) in cartInfoList" :key="cart.id">
                    ...
                    <li class="cart-list-con5">
                        <a href="javascript:void(0)" class="cute" @click="handler('cute',-1,cart)">-</a>
                        <input autocomplete="off" type="text" minnum="1" class="itxt" :value="cart.skuNum" @click="handler('change',$event.target.value*1,cart)">
                        <a href="javascript:void(0)" class="add" @click="handler('add',+1,cart)">+</a>
                    </li>
...
export default {
        ...
        handler: throttle(async function (type, disNum, cart) {
            ...
            switch (type) {
                ...
                case 'change':
                    ...
                    // 简写形式: disNum = (isNaN(disNum)||disNum<1)?0:parseInt(disNum)-cart.skuNum;
                    break
            }
            // 派发action
            try {
    ...
    computed: {
        ...
        isAllCheck() {
            // 遍历数组里面原理，只要全部元素isChecked属性都为1===>真 truel,只要有一个不是1-=====>假false
